  ...
  \cventry
    ...
    {Feb 2022 - Apr 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of project
        ...
        \cvtechskills{Tableau, Overleaf, LaTeX.}
        \cvsoftskills{Time Management, Teamwork, Presentation skills, Report writing.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Nov 2021 - Dec 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of project
        ...
        \cvtechskills{Python with Pandas, matplotlib, Seaborn.}
        \cvsoftskills{Presentation skills, Leadership, Teamwork, Logical Thinking.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Oct 2021 - Dec 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of project
        ...
        \cvtechskills{R with ggplot2, tidyr, R Markdown.}
        \cvsoftskills{Report writing, Logical Thinking, Critical Thinking.}
      \end{cvitems}
    }
