  ...
  \cventry
    ...
    {Sept 2020 - Aug 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \cvtechskills{Python with PyTorch, NumPy, Matplotlib, Pandas, Scikit-learn, C++, Ubuntu Linux, Linux tools, Apt, Scripting, Git.}
        \cvsoftskills{Teamwork, Time Management, Communication, Presentation skills.}
      \end{cvitems}
    }
